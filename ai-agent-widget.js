...
(function () {
  var LOGIN_CONFIG = {
    apiKey: "AIzaSyDEL2RpEcnaUHpJjRcmBYGE5d3cT_EzMD4",
    authDomain: "veera730amonline.firebaseapp.com",
    projectId: "veera730amonline",
    storageBucket: "veera730amonline.firebasestorage.app",
    messagingSenderId: "618070147836",
    appId: "1:618070147836:web:08b9c7905ab7294aa40d79"
  };
  ...
  /* ── Single-device login guard ─────────────────────────────────────
     ...
     veera730amonline project). This piece always reads the DEFAULT
  ...
  async function start() {
    ...
    try {
      app = fb.apps && fb.apps.length
        ? (fb.apps.find(function(a){ return a.options && a.options.projectId === 'veera730amonline'; }) || fb.initializeApp(LOGIN_CONFIG, 'usagetracker'))
